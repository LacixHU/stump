...
describe('ReadingDirectionSelect', () => {
	...
	it('should properly update the reading direction', () => {
		...
		fireEvent.change(getByLabelText('reader.readingDirection'), { target: { value: 'RTL' } })
		expect(onChange).toHaveBeenCalledWith(ReadingDirection.Rtl)

		fireEvent.change(getByLabelText('reader.readingDirection'), { target: { value: 'LTR' } })
	...
	it('should not allow invalid reading directions', () => {
		...
		fireEvent.change(getByLabelText('reader.readingDirection'), { target: { value: 'invalid' } })
