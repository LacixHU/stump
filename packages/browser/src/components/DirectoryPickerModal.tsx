	...
	return (
		<Dialog open={isOpen} onOpenChange={handleOpenChange}>
			<Dialog.Content size="md">
				<Dialog.Header>
					<Dialog.Title>{t('directoryPicker.title')}</Dialog.Title>
					<Dialog.Description>{t('directoryPicker.description')}</Dialog.Description>
				...
				<Dialog.Footer className="gap-3 sm:justify-between sm:gap-0 w-full items-center">
					<CheckBox label={t('directoryPicker.showHidden')} checked={showHidden} onClick={toggle} />
